...
<InputField type="text" placeholder="Last Name" name="lastName" handleChange={handleChange} address={address} />
  ...
  <InputField type="email" placeholder="Email" name="email" handleChange={handleChange} address={address} />
  ...
  <div className='grid grid-cols-2 gap-2'>
    <InputField type="text" placeholder="Zipcode" name="zipcode" handleChange={handleChange} address={address} />
...
<button type="submit" className='w-full bg-primary cursor-pointer text-white px-4 py-2 rounded hover:bg-secondary transition'>Save Address</button>
